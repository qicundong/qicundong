...
$sharepost_desc_reel = '<br><p class="wpw-auto-poster-meta wpw-auto-poster-meta_second facebook_note"><strong>' . esc_html__('Note : ', 'wpwautoposter') . '</strong> ' . sprintf(esc_html__('If you are posting a reel, please ensure that the video format is .mp4 (recommended). The video duration must be between 3 seconds and 90 seconds. The Aspect Ratio must be 9 x 16. ', 'wpwautoposter'), '<strong>', '</strong>') . '</p>';
$poster_meta->addVideo( $prefix . 'fb_post_reel', array('name' => esc_html__('Post Reel : ', 'wpwautoposter'), 'desc' => esc_html__('Here you can upload a video which will be used for the facebook reel. ', 'wpwautoposter').$sharepost_desc_reel, 'tab' => 'wpw_facebook', 'show_path' => true, 'class' => $prefix . 'validate-video _wpweb_fb_post_reel') );
...
// 				</div>
// 			</div>
// 			<code>{CF-CustomFieldName}</code><span class="description">' . sprintf(esc_html__('inserts the contents of the custom field with the specified name. %s E.g. If your price is stored in the custom field "PRDPRICE" you will need to use {CF-PRDPRICE} tag.%s', 'wpwautoposter'), "<b>", "</b>"
// 				) .
// 				'</span></div>			
// 	</div>', 'tab' => 'wpw_facebook' )
// );
