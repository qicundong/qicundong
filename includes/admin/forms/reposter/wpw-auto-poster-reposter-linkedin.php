...
$repost_li_global_message_template = isset( $wpw_auto_poster_reposter_options['repost_li_global_message_template'] ) ? $wpw_auto_poster_reposter_options['repost_li_global_message_template'] : '';

$repost_li_custom_msg_options = isset( $wpw_auto_poster_reposter_options['repost_li_custom_msg_options'] ) ? $wpw_auto_poster_reposter_options['repost_li_custom_msg_options'] : 'global_msg';

if( $repost_li_custom_msg_options == 'global_msg') {
			...
			<div id="linkedin_general" class="postbox">	
				<div class="handlediv" title="<?php esc_html_e( 'Click to toggle', 'wpwautoposter' ); ?>"><br /></div>
					...
					<h3 class="hndle">
						...
						<span class='wpw-sap-buffer-app-settings'><?php esc_html_e( 'LinkedIn Settings', 'wpwautoposter' ); ?></span>
					</h3>
					...
					<div class="inside">
						...
						<table class="form-table">											
							<tbody>
								<tr valign="top">
									<th scope="row">
										<label for="wpw_auto_poster_reposter_options[enable_linkedin]"><?php esc_html_e( 'Enable Repost : ', 'wpwautoposter' ); ?></label>
									</th>
									<td>
										<div class="d-flex-wrap fb-avatra" bis_skin_checked="1">	
											<label class="toggle-switch" for="wpw_auto_poster_reposter_options[enable_linkedin]">
								...
								<tr valign="top">
									<th scope="row">
										<label for="wpw_auto_poster_reposter_options[enable_linkedin_for]"><?php esc_html_e( 'Repost for : ', 'wpwautoposter' ); ?></label>
									</th>
									<td>
										<ul>
										<?php 
											...
											<li class="wpw-auto-poster-prevent-types">
												<input type="checkbox" id="wpw_auto_posting_linkedin_prevent_<?php echo esc_attr($type->name); ?>" name="wpw_auto_poster_reposter_options[enable_linkedin_for][]" value="<?php echo esc_attr($type->name); ?>" <?php echo esc_attr($selected); ?>/>
										...
										<p><small><?php esc_html_e( 'Check each of the post types that you want to post automatically to LinkedIn.', 'wpwautoposter' ); ?></small></p>  
									</td>
								</tr>

								<tr valign="top">
									<th scope="row">
										<label for="wpw_auto_poster_reposter_options[li_post_type_cats][]"><?php esc_html_e( 'Select Taxonomies : ', 'wpwautoposter' ); ?></label> 
									</th>
									<td class="wpw-auto-poster-select">
										...
										<select name="wpw_auto_poster_reposter_options[li_post_type_cats][]" id="wpw_auto_poster_reposter_options[li_post_type_cats]" class="li_post_type_cats ajax-taxonomy-search wpw-auto-poster-cats-tags-select" multiple="multiple">
										<?php

											$li_reposter_exclude_cats_selected_values = !empty($wpw_auto_poster_reposter_options['li_post_type_cats']) ? $wpw_auto_poster_reposter_options['li_post_type_cats'] : array();	
											$selected = 'selected="selected"';

											if(!empty($li_reposter_exclude_cats_selected_values)) {

												foreach ($li_reposter_exclude_cats_selected_values as $post_type => $post_data) {
								...
								<tr valign="top">
									<th scope="row">
										<label for="wpw_auto_poster_reposter_options[li_post_ids_exclude]"><?php esc_html_e( 'Exclude Posts : ', 'wpwautoposter' ); ?></label>
									</th>
									<td>
										<textarea placeholder="1100,1200,1300" cols="35" id="wpw_auto_poster_reposter_options[li_post_ids_exclude]" name="wpw_auto_poster_reposter_options[li_post_ids_exclude]"><?php echo esc_attr($exludes_post_ids); ?></textarea>
										<p><small>
								...
								<tr valign="top" class="wpw-auto-poster-schedule-limit">
									<th scope="row">
										<label for="wpw_auto_poster_reposter_options[li_posts_limit]"><?php esc_html_e( 'Maximum Posting per schedule : ', 'wpwautoposter' ); ?></label>
									</th>
									<td>
										<input id="wpw_auto_poster_reposter_options[li_posts_limit]" name="wpw_auto_poster_reposter_options[li_posts_limit]" type="number" value="<?php echo esc_attr($wpw_auto_poster_reposter_options['li_posts_limit']); ?>" min="0" max="<?php print esc_attr(WPW_AUTO_POSTER_POST_LIMIT); ?>" />
										<p><small>
								...
								<tr valign="top">
									...
									<td class="wpw-auto-poster-cats-option">
										<div class="radio-button-wrap">
											<input id="li_custom_global_msg" type="radio" name="wpw_auto_poster_reposter_options[repost_li_custom_msg_options]" value="global_msg" <?php checked($repost_li_custom_msg_options, 'global_msg', true);?>>
											<label for="li_custom_global_msg" class="wpw-auto-poster-label-check"><?php esc_html_e( 'Global', 'wpwautoposter' ); ?></label>
										</div>
										<div class="radio-button-wrap">
											<input id="li_custom_post_msg" type="radio" name="wpw_auto_poster_reposter_options[repost_li_custom_msg_options]" value="post_msg" <?php checked($repost_li_custom_msg_options, 'post_msg', true);?>>
								...
								<tr valign="top" class="global_title_tr <?php echo isset( $global_title_style ) ? esc_attr($global_title_style) : ''; ?>">									
									<th scope="row">
										<label for="wpw_auto_poster_reposter_options[repost_li_global_title_template]"><?php esc_html_e( 'Custom Title : ', 'wpwautoposter' ); ?></label>
									</th>
									<td class="form-table-td">
										<?php 
											$repost_li_template_title_text = ( !empty( $wpw_auto_poster_reposter_options['repost_li_global_title_template'] ) ) ? $wpw_auto_poster_reposter_options['repost_li_global_title_template'] : '';
										?>
										<input type="text" name="wpw_auto_poster_reposter_options[repost_li_global_title_template]" id="wpw_auto_poster_reposter_options[repost_li_global_title_template]" class="large-text" value="<?php echo $model->wpw_auto_poster_escape_attr( $repost_li_template_title_text ); ?>">
									</td>	
								...
								<tr valign="top" class="global_msg_tr <?php echo esc_attr($global_msg_style); ?>">									
									<th scope="row">
										<label for="wpw_auto_poster_reposter_options[repost_li_global_message_template]"><?php esc_html_e( 'Custom Message : ', 'wpwautoposter' ); ?></label>
									</th>
									<td>
										<textarea type="text" name="wpw_auto_poster_reposter_options[repost_li_global_message_template]" id="wpw_auto_poster_reposter_options[repost_li_global_message_template]" class="large-text"><?php echo $model->wpw_auto_poster_escape_attr( $repost_li_global_message_template ); ?></textarea>
									</td>	
								</tr>
								...
								<tr id="custom_post_type_templates_li" class="post_msg_tr <?php echo esc_attr($post_msg_style); ?>">
									<th colspan="2">
									  	...
									  	foreach( $all_types as $type ) {	
											...
											$wpw_auto_poster_reposter_options['repost_li_global_message_template_'.$type->name] = ( isset( $wpw_auto_poster_reposter_options['repost_li_global_message_template_'.$type->name] ) ) ? $wpw_auto_poster_reposter_options['repost_li_global_message_template_'.$type->name] : '';
									  	?>
									  	<table id="tabs-<?php echo esc_attr($type->name); ?>">
											<tr valign="top">
												...
												<td>
													<textarea type="text" name="wpw_auto_poster_reposter_options[repost_li_global_message_template_<?php echo esc_attr($type->name); ?>]" id="wpw_auto_posting_li_custom_msg_<?php echo esc_attr($type->name); ?>" class="large-text"><?php echo $model->wpw_auto_poster_escape_attr( $wpw_auto_poster_reposter_options['repost_li_global_message_template_'.$type->name] ); ?></textarea>
												</td>	
											</tr>
											<tr valign="top">								
                                                <th scope="row"></th>
