					...
					<table class="form-table"><tbody>
						<tr valign="top">
                            ...
                            <div class="d-flex-wrap fb-avatra" bis_skin_checked="1">	
                                <label class="toggle-switch" for="wpw_auto_poster_reposter_options[enable_wordpress]">
                                ...
                                <p><?php esc_html_e( 'Check this box, if you want to automatically post your new content to WordPress.', 'wpwautoposter' ); ?></p>
                                </div>
							</td>
						</tr>
						...
						<tr valign="top">
							...
							<td class="wpw-auto-poster-cats-option">
                                <div class="radio-button-wrap">
                                    ...
                                    <label for="wp_custom_global_msg" class="wpw-auto-poster-label-check"><?php esc_html_e( 'Global', 'wpwautoposter' ); ?></label>
                                </div>
                                <div class="radio-button-wrap">
                                    ...
                                    <label for="wp_custom_post_msg" class="wpw-auto-poster-label-check"><?php esc_html_e( 'Individual Post Type Message', 'wpwautoposter' ); ?></label>
                                </div>
							</td>
						</tr>
						...
						<tr valign="top" class="global_msg_tr <?php echo $global_msg_style; ?>">
							<th scope="row"></th>
							<td class="global_msg_td">
								<p><?php esc_html_e( 'Here you can enter default content which will be used for the website posting. Leave it empty to use the post level message. You can use following template tags within the content template:', 'wpwautoposter' ); ?>
								<?php 
