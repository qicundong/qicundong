                ...
                <div class="inside">
                    ...
                    <table class="form-table">											
                        <tbody>
                            <tr valign="top">
                                <th scope="row">
                                    <label for="wpw_auto_poster_reposter_options[enable_googlemybusiness]"><?php esc_html_e('Enable Repost : ', 'wpwautoposter'); ?></label>
                                </th>
                                <td>
                                    <div class="d-flex-wrap fb-avatra" bis_skin_checked="1">	
                                    <label class="toggle-switch" for="wpw_auto_poster_reposter_options[enable_googlemybusiness]">
...
<?php } ?>
                            ...
                            <tr valign="top">
                                ...
                                <td class="wpw-auto-poster-select">
                                    ...
                                    <select name="wpw_auto_poster_reposter_options[gmb_post_type_cats][]" id="wpw_auto_poster_reposter_options[gmb_post_type_cats]" class="gmb_post_type_cats ajax-taxonomy-search wpw-auto-poster-cats-tags-select" multiple="multiple">
                                    <?php

                                        $gmb_reposter_exclude_cats_selected_values = !empty($wpw_auto_poster_reposter_options['gmb_post_type_cats']) ? $wpw_auto_poster_reposter_options['gmb_post_type_cats'] : array();	
                                        $selected = 'selected="selected"';

                                        if(!empty($gmb_reposter_exclude_cats_selected_values)) {

                                            foreach ($gmb_reposter_exclude_cats_selected_values as $post_type => $post_data) {
