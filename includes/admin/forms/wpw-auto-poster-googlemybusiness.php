    ...
    <div class="metabox-holder">	
        <div class="meta-box-sortables ui-sortable">
            <div id="gmb_general" class="postbox">	
                ...
                <h3 class="hndle">
					<img src="<?php echo esc_url(WPW_AUTO_POSTER_URL); ?>includes/images/googlemybusiness_set.png" alt="Google My Business">
                ...
                <div class="inside">
                    ...
                    <table class="form-table">											
                        <tbody>				
                            <tr valign="top">
                                <th scope="row">
                                    <label for="wpw_auto_poster_options[enable_googlemybusiness]"><?php esc_html_e('Enable Autoposting : ', 'wpwautoposter'); ?></label>
                                </th>
                                <td>
                                    <div class="d-flex-wrap fb-avatra">
                                        <label for="wpw_auto_poster_options[enable_googlemybusiness]" class="toggle-switch">
                                        ...
                                        <p><?php esc_html_e('Check this box, if you want to automatically post your new content to Google My Business.', 'wpwautoposter'); ?></p>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                <th scope="row">
                                    <label for="wpw_auto_poster_options[enable_googlemybusiness_for]"><?php esc_html_e('Enable Autoposting for : ', 'wpwautoposter'); ?></label>
                                </th>
                                <td>
                            ...
                            <tr valign="top">
                                <th scope="row">
                                    <label for="wpw_auto_poster_options[gmb_post_type_tags][]"><?php esc_html_e('Select Tags for hashtags : ', 'wpwautoposter'); ?></label> 
                                </th>
                            ...
                            <tr valign="top">
                                <th scope="row">
                                    <label for="wpw_auto_poster_options[gmb_post_type_cats][]"><?php esc_html_e('Select Categories for hashtags : ', 'wpwautoposter'); ?></label> 
                                </th>
                                <td class="wpw-auto-poster-select">
                            ...
                            <tr valign="top">
                                ...
                                <td class="wpw-auto-poster-select">
                                    ...
                                    <select name="wpw_auto_poster_options[gmb_exclude_cats][]" id="wpw_auto_poster_options[gmb_exclude_cats]" class="gmb_exclude_cats ajax-taxonomy-search wpw-auto-poster-cats-exclude-select" multiple="multiple">

                                    <?php

                                        $gmb_exclude_cats_selected_values = !empty($wpw_auto_poster_options['gmb_exclude_cats']) ? $wpw_auto_poster_options['gmb_exclude_cats'] : array();
                                        $selected = 'selected="selected"';

                                        if(!empty($gmb_exclude_cats_selected_values)) {

                                            foreach ($gmb_exclude_cats_selected_values as $post_type => $post_data) {
                            ...
                            <tr id="row-gmb-wp-pretty-url" valign="top" class="<?php print $gmb_wp_pretty_url_css; ?>">
                                ...
                                <td>
                                    <div class="d-flex-wrap fb-avatra">
                                        <label for="wpw_auto_poster_options[gmb_wp_pretty_url]" class="toggle-switch">
    ...
    <div class="metabox-holder">	
        <div class="meta-box-sortables ui-sortable">
            <div id="gmb_api" class="postbox">	
                ...
                <div class="inside">
                    <?php $wpweb_gmb_button = apply_filters( 'wpweb_gmb_button', true ); ?>
                    <?php if( $wpweb_gmb_button ){ ?>
                            ...
                            <tbody>				
                                <tr valign="top" class="wpw-auto-poster-facebook-account-details-custom-method <?php echo!empty($gmb_accounts) ? 'wpw-auto-poster-facebook-custom-app-added' : '' ?>"  data-row-id="">
                                    <td scope="row" class="row-btn" colspan="3">
                                        <?php
                                        echo '<a class="wpw-auto-poster-add-more-gmb-account button-primary" href="' . $gmbposting->wpw_auto_poster_get_gmb_app_method_login_url() . '">' . esc_html__('Add GMB Account', 'wpwautoposter') . '</a>';
                                        ?>
                                    </td>
                                </tr>
                ...
                <div class="inside">
                    <table class="form-table">											
                        <tbody>
                            <tr valign="top"> 
                                <th scope="row">
                                    <label for="wpw_auto_poster_options[prevent_post_gmb_metabox]"><?php esc_html_e('Do not allow individual posts : ', 'wpwautoposter'); ?></label>
                                </th>									
                                <td>
                                    <div class="d-flex-wrap fb-avatra">
                                        <label for="wpw_auto_poster_options[prevent_post_gmb_metabox]" class="toggle-switch">
                                            <input name="wpw_auto_poster_options[prevent_post_gmb_metabox]" id="wpw_auto_poster_options[prevent_post_gmb_metabox]" type="checkbox" value="1" <?php if (isset($wpw_auto_poster_options['prevent_post_gmb_metabox'])) { checked('1', $wpw_auto_poster_options['prevent_post_gmb_metabox']);
                                                }?> />
                                                <span class="slider"></span>
                                        </label>
                                        <p><?php esc_html_e('If you check this box, then it will hide meta settings for google my business from individual posts.', 'wpwautoposter'); ?></p>
                                    </div>
                                </td>	
                            </tr>
                                    ...
                                    foreach ($types as $type) {
                                        ...
                                        <div class="wpw-auto-poster-fb-types-wrap">
                                            <div class="wpw-auto-poster-tw-types-label">
                                                ...
                                                echo ' ' . $label;
                                                esc_html_e(' to Google My Business of this user(s)', 'wpwautoposter');
                                                ?>
                                ...
                                <td class="wpw-auto-poster-cats-option">
                                    <div class="wpw-auto-poster-cats-option">
                                        <div class="radio-button-wrap">
                                            ...
                                            <label for="gmb_custom_global_msg" class="wpw-auto-poster-label-check"><?php esc_html_e('Global', 'wpwautoposter'); ?></label>
                                        </div>
                                        <div class="radio-button-wrap">
                                            ...
                                            <label for="gmb_custom_post_msg" class="wpw-auto-poster-label-check"><?php esc_html_e('Individual Post Type Message', 'wpwautoposter'); ?></label>
                                        </div>
                                    </div>
                                </td>	
                            </tr>
