				...
				<div class="wpw-auto-poster-error info"><ul><li><?php print sprintf(esc_html__( 'Note:  Youtube data API allows only 10K units (5 videos) per day. For more details %sclick here%s.', 'wpwautoposter' ), '<a href="'.esc_url('https://developers.google.com/youtube/v3/getting-started#quota').'" target="_blank">','</a>' ); ?></li></ul></div>
					<table class="form-table">											
						<tbody>				
							<tr valign="top">
								<th scope="row">
									<label for="wpw_auto_poster_options[enable_youtube]"><?php esc_html_e( 'Enable Autoposting : ', 'wpwautoposter' ); ?></label>
								</th>
								<td>
									<div class="d-flex-wrap fb-avatra">
										<label for="wpw_auto_poster_options[enable_youtube]" class="toggle-switch">
							...
							<tr valign="top">
								<th scope="row">
									<label for="wpw_auto_poster_options[enable_youtube_for]"><?php esc_html_e( 'Enable Autoposting for : ', 'wpwautoposter' ); ?></label>
								</th>
								<td>
								...
								<tr valign="top">
									<th scope="row">
										<label for="wpw_auto_poster_options[yt_post_type_tags][]"><?php esc_html_e( 'Select Tags for hashtags : ', 'wpwautoposter' ); ?></label> 
									</th>
									...
									<tr valign="top">
										<th scope="row">
											<label for="wpw_auto_poster_options[yt_post_type_cats][]"><?php esc_html_e( 'Select Categories for hashtags : ', 'wpwautoposter' ); ?></label> 
										</th>
										<td class="wpw-auto-poster-select">
									...
									<tr valign="top">
										...
										<td class="wpw-auto-poster-select">
											...
											<select name="wpw_auto_poster_options[yt_exclude_cats][]" id="wpw_auto_poster_options[yt_exclude_cats]" class="yt_exclude_cats ajax-taxonomy-search wpw-auto-poster-cats-exclude-select" multiple="multiple">

											<?php

												$yt_exclude_cats_selected_values = !empty($wpw_auto_poster_options['yt_exclude_cats']) ? $wpw_auto_poster_options['yt_exclude_cats'] : array();
												$selected = 'selected="selected"';

												if(!empty($yt_exclude_cats_selected_values)) {

													foreach ($yt_exclude_cats_selected_values as $post_type => $post_data) {
									...
									<tr id="row-yt-wp-pretty-url" valign="top" style="<?php print esc_attr($yt_wp_pretty_url_css);?>">
										...
										<td>
											<div class="d-flex-wrap fb-avatra">
												<label for="wpw_auto_poster_options[yt_wp_pretty_url]" class="toggle-switch">
						...
						<div class="inside">
							<table class="form-table wpw-auto-poster-youtube-settings">
								<tbody>				
									<tr valign="top">
										<td colspan="4">
											<div class="wpw-auto-poster-error info">
		                                        <ul>
		                                            <li>
		                                                <?php printf( esc_html__( '%sNote:%s Before you can start publishing your content to YouTube you need to create Google Application.', 'wpwautoposter' ),'<b>','</b>'); ?>
		                                                <?php printf( esc_html__('You can get a step by step tutorial on how to create a Google Application on our %sDocumentation%s.', 'wpwautoposter' ), '<a href="'.esc_url('https://docs.wpwebelite.com/social-network-integration/youtube/').'" target="_blank">', '</a>' ); ?>
										...
										if( !empty( $youtube_keys ) ) {
											foreach ( $youtube_keys as $youtube_key => $youtube_value ) {
												...
												<tr valign="top" class="wpw-auto-poster-youtube-account-details" data-row-id="<?php echo esc_attr($youtube_key); ?>">
													...
													<td scope="row" width="25%" valign="top" data-label="<?php _e( 'Valid OAuth redirect URIs', 'wpwautoposter' ); ?>">
														...
														<input class="yt-oauth-url" id="yt-oauth-url-<?php print esc_attr($youtube_value['app_id']);?>" type="text" value="<?php echo esc_attr($valid_auto_redirect_url); ?>" size="30" readonly/><button type="button" data-appid="<?php print esc_attr($youtube_value['app_id']);?>" class="yt-copy-clipboard">
																<div class="link-icon">
																		<img src="<?php echo esc_url(WPW_AUTO_POSTER_IMG_URL); ?>/link-icon.svg" alt="">
													...
													<td>
														<a href="javascript:void(0);" class="wpw-auto-poster-delete-yt-account wpw-auto-poster-youtube-remove <?php echo esc_attr($youtube_delete_class); ?>" title="<?php esc_html_e( 'Delete', 'wpwautoposter' ); ?>"><img src="<?php echo esc_url(WPW_AUTO_POSTER_IMG_URL); ?>/close-icon.svg" alt="<?php esc_html_e('Delete','wpwautoposter'); ?>"/></a>
													</td>
												</tr>
											<?php 
											}
											...
											<tr valign="top" class="wpw-auto-poster-youtube-account-details" data-row-id="<?php echo empty($youtube_key) ? '': esc_attr($youtube_key); ?>">
												...
												<td style="<?php echo esc_attr($hide_button); ?>">
													<a href="javascript:void(0);" class="wpw-auto-poster-delete-yt-account wpw-auto-poster-youtube-remove" title="<?php esc_html_e( 'Delete', 'wpwautoposter' ); ?>"><img src="<?php echo esc_url(WPW_AUTO_POSTER_IMG_URL); ?>/close-icon.svg" alt="<?php esc_html_e('Delete','wpwautoposter'); ?>"/></a>
												</td>
											</tr>
										<?php } ?>
										</tbody>
									...
									<?php $yt_api_add_more = apply_filters( 'wpweb_yt_api_add_more_button', true ); ?>
                        			<?php if( $yt_api_add_more ){ ?>
										<tr>
											<td colspan="4">
												<a class='wpw-auto-poster-add-more-yt-account button-primary' href='javascript:void(0);'><?php esc_html_e( 'Add Another App', 'wpwautoposter' ); ?></a>
											</td>
										</tr>
									<?php } ?>
						...
						<div class="inside">
							...
							<table class="form-table">											
								<tbody>
									...
									<tr valign="top"> 
										<th scope="row">
											<label for="wpw_auto_poster_options[prevent_post_yt_metabox]"><?php esc_html_e( 'Do not allow individual posts : ', 'wpwautoposter' ); ?></label>
										</th>									
										<td>
											<div class="d-flex-wrap fb-avatra">
												<label for="wpw_auto_poster_options[prevent_post_yt_metabox]" class="toggle-switch">
												...
												<p><?php esc_html_e( 'If you check this box, then it will hide meta settings for youtube from individual posts.', 'wpwautoposter' ); ?></p>
											</div>
										</td>	
									</tr>
									...
									<tr valign="top">
												...
												if( isset( $type->labels ) ) {
													...
													<div class="wpw-auto-poster-fb-types-wrap">
														<div class="wpw-auto-poster-tw-types-label">
															...
															echo ' '.esc_html($label); 
															esc_html_e( ' to YouTube of this user(s)', 'wpwautoposter' ); ?>
										...
										<tr valign="top" class="global_title_yt <?php echo isset( $global_title_style ) ? esc_attr($global_title_style) : ''; ?>">									
											<th scope="row">
												<label for="wpw_auto_poster_options[yt_global_title_template]"><?php esc_html_e( 'Custom Title : ', 'wpwautoposter' ); ?></label>
											</th>
											<td class="form-table-td">
												<?php 				
												$yt_template_title_text = ( !empty( $wpw_auto_poster_options['yt_global_title_template'] ) ) ? $wpw_auto_poster_options['yt_global_title_template'] : '';
												?>	
												<input type="text" name="wpw_auto_poster_options[yt_global_title_template]" id="wpw_auto_poster_options[yt_global_title_template]" class="large-text" value="<?php echo $model->wpw_auto_poster_escape_attr( $yt_template_title_text ); ?>">
											</td>	
										...
										<tr valign="top">									
											...
											<td class="global_msg_td">
												...
												<?php 
												$yt_template_title_str = '<div class="short-code-list">
								...
								<tr valign="top">									
									<th scope="row"></th>
									<td class="global_msg_td">
										<p><?php esc_html_e( 'Here you can enter default description of video will be used for the YouTube posting. Leave it empty to use the post level description. You can use following template tags within the caption template:', 'wpwautoposter' ); ?>
										<?php 
